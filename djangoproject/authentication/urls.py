from .views import RegistrationView,LogoutView,CompletePasswordReset,RequestPasswordResetEmail,UsernameValidationView,EmailValidationView,VerificationView,LoginView
